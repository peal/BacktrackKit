...
>   can1 :=  BTKit_SimpleCanonicalSearch(PartitionStack(m), [BTKit_Refiner.GraphStab(g)]);
>   can2 :=  BTKit_SimpleCanonicalSearch(PartitionStack(m), [BTKit_Refiner.GraphStab(g2)]);
